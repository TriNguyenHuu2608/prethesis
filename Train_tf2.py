...
def train(X_train, X_test, y_train, y_test, X_val, y_val, test):
    num_epochs = 2000
    inputs = tf.keras.Input(shape = (2, 150))
    L1 = tf.keras.layers.Dense(30, activation = 'sigmoid')(inputs)
